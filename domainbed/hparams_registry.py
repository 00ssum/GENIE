...
def _hparams(algorithm, dataset, random_state):
    ...
    if algorithm in ["DANN", "CDANN"]:
        ...
        hparams["rho"] = (0.05, random_state.choice([0.01, 0.02, 0.05, 0.1]))
        hparams["sagm_alpha"] = (0.001, random_state.choice([0.01, 0.02, 0.05, 0.1]))

    elif algorithm == "GSAM_DG":
        hparams["rho"] = (0.05, random_state.choice([0.01, 0.02, 0.05, 0.1]))
        hparams["gsam_alpha"] = (0.001, random_state.choice([0.01, 0.02, 0.05, 0.1]))
    ...
    #     hparams["lambda"] = (1000., 10 ** random_state.uniform(1., 4.))
    #     hparams["penalty_anneal_iters"] = (1500, int(random_state.uniform(0., 5000.)))
    #     hparams["ema"] = (0.95, random_state.uniform(0.90, 0.99))

    elif algorithm == 'gsnr1106':
    ...
    elif algorithm == 'prob1106':
        hparams['momentum'] = (0.9, random_state.uniform(0.8, 0.999))
        hparams['convergence_rate'] = (0.015, 10 ** random_state.uniform(-3, -1))
        hparams['moving_avg']= ( 0.95, random_state.uniform(0.9, 0.999))

    elif algorithm == 'GENIE':
        hparams['momentum'] = (0.9, random_state.uniform(0.8, 0.999))
        hparams['convergence_rate'] = (0.015, 10 ** random_state.uniform(-3, -1))
        hparams['moving_avg']= ( 0.95, random_state.uniform(0.9, 0.999))
    ...
    elif algorithm == 'GENIE_Noise':
        hparams['momentum'] = (0.9, random_state.uniform(0.8, 0.999))
        hparams['convergence_rate'] = (0.015, 10 ** random_state.uniform(-3, -1))
        hparams['moving_avg']= ( 0.95, random_state.uniform(0.9, 0.999))

    elif algorithm == 'GENIE_Mask':
        hparams['momentum'] = (0.9, random_state.uniform(0.8, 0.999))
        hparams['convergence_rate'] = (0.015, 10 ** random_state.uniform(-3, -1))
        hparams['moving_avg']= ( 0.95, random_state.uniform(0.9, 0.999))
        hparams['p'] =( 0.4, random_state.uniform(0.1, 0.8))
